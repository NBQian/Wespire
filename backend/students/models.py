...
class Product(models.Model):
    ...
    WholeLife = models.DecimalField(max_digits=14, decimal_places=2)
    Endowment = models.DecimalField(max_digits=14, decimal_places=2)
    Term = models.DecimalField(max_digits=14, decimal_places=2)
    InvLinked = models.DecimalField(max_digits=14, decimal_places=2)
